...
const pasaporteLetra = prompt("Ingrese las letra que identifica su pasaporte").toUpperCase();
const pasaporte = prompt("Ingrese el número de su pasaporte");
console.info(`N° Pasaporte: ${pasaporteLetra}${pasaporte}`);

//NACIONAL
const pasaporteNacional = pasaporteLetra === "A";
